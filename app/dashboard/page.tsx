    ...
    <main className="mx-auto min-h-screen max-w-2xl bg-white px-5 py-8 text-zinc-900">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500">Hi {seller?.owner_name} 👋</p>
        </div>
        <button
          onClick={signOut}
      ...
      <div className="mt-6 grid grid-cols-3 gap-3">
        ...
        <div className="rounded-2xl bg-amber-50 p-4">
          <p className="text-xs font-medium text-amber-700">UNPAID</p>
          <p className="mt-1 text-xl font-bold text-amber-900">
            {pendingCount}
          </p>
          <p className="text-xs text-amber-700">invoices</p>
        </div>
      </div>
      ...
      <h2 className="mt-8 text-sm font-semibold text-zinc-500">INVOICES</h2>
      {invoices.length === 0 ? (
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                {inv.is_paid ? (
                  ...
                  >
                    {busyInv === inv.invoice_number ? "..." : "Mark paid"}
                  </button>
                )}
              </div>
            </div>
